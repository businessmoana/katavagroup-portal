...

    {
      title: (
        <TitleWithSort
          ...
          ascending={
            sortingObj.sort === SortOrder.Asc &&
            sortingObj.column === 'invoice_number'
          }
    ...
    },
    {
      title: (
        <TitleWithSort
          title={'Ship Date'}
          ascending={
            sortingObj.sort === SortOrder.Asc && sortingObj.column === 'ship_date'
          }
...
export default ChefInvoicesList;
