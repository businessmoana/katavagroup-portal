...
const PriceGroupDeleteView = dynamic(
  () => import('@/components/price-group/price-group-delete-view'),
);
const InActivePriceGroupView = dynamic(
  () => import('@/components/price-group/inactive-price-group-view'),
);
const ActivePriceGroupView = dynamic(
  () => import('@/components/price-group/active-price-group-view'),
);
const ActiveDateIntervalView = dynamic(
  () => import('@/components/date-interval/active-view'),
);
const InActiveDateIntervalView = dynamic(
  () => import('@/components/date-interval/inactive-view'),
);
const DateIntervalDeleteView = dynamic(
  () => import('@/components/date-interval/delete-view'),
);
const SalesDeleteView = dynamic(() => import('@/components/sales/delete-view'));
const UpdateOrCreateSalesView = dynamic(
  () => import('@/components/sales/form'),
);
const UpdateOrCreateChefsStatementView = dynamic(
  () => import('@/components/chefs-statement/form'),
);
const UpdateOrCreatePackageView = dynamic(
  () => import('@/components/product/product-package-form'),
);
const DeleteOrderItemView = dynamic(
  () => import('@/components/pick-pack/delete-order-item-view'),
);
const NewOrderItemView = dynamic(
  () => import('@/components/pick-pack/new-order-item-view'),
);
const EditOrderItemView = dynamic(
  () => import('@/components/pick-pack/edit-order-item-view'),
);
const DeleteOrderView = dynamic(
  () => import('@/components/pick-pack/delete-order-view'),
);
...
const ActiveChefView = dynamic(
  () => import('@/components/chef/active-chef-view'),
);
const InActiveChefView = dynamic(
  () => import('@/components/chef/inactive-chef-view'),
);
const ChefDeleteView = dynamic(
  () => import('@/components/chef/chef-delete-view'),
);
...
function renderModal(view: MODAL_VIEWS | undefined, data: any) {
  switch (view) {
    ...
    case 'SELECT_PRODUCT_VARIATION':
      return <ProductVariation item={data} />;
    ...
    case 'CHEF_ACTIVE_VIEW':
      return <ActiveChefView />;
    case 'CHEF_INACTIVE_VIEW':
      return <InActiveChefView />;
    case 'DELETE_CHEF':
      return <ChefDeleteView />;
    case 'PRICE_GROUP_ACTIVE_VIEW':
      return <ActivePriceGroupView />;
    case 'PRICE_GROUP_INACTIVE_VIEW':
      return <InActivePriceGroupView />;
    case 'DELETE_PRICE_GROUP':
      return <PriceGroupDeleteView />;
    case 'DATE_INTERVAL_ACTIVE_VIEW':
      return <ActiveDateIntervalView />;
    case 'DATE_INTERVAL_INACTIVE_VIEW':
      return <InActiveDateIntervalView />;
    case 'DELETE_DATE_INTERVAL':
      return <DateIntervalDeleteView />;
    case 'DELETE_SALES':
      return <SalesDeleteView />;
    ...
    case 'UPDATE_OR_CREATE_SALES':
      return <UpdateOrCreateSalesView />;
    case 'UPDATE_OR_CREATE_PACKAGE':
      return <UpdateOrCreatePackageView />;
    case 'UPDATE_OR_CREATE_CHEFS_STATEMENT':
      return <UpdateOrCreateChefsStatementView />;
    case 'DELETE_ORDER_ITEM':
      return <DeleteOrderItemView />;
    case 'NEW_ORDER_ITEM':
      return <NewOrderItemView />;
    case 'EDIT_ORDER_ITEM':
      return <EditOrderItemView />;
    case 'DELETE_ORDER':
