...
export type MODAL_VIEWS =
  ...
  | 'CHEF_INACTIVE_VIEW'
  | 'DELETE_CHEF'
  | 'PRICE_GROUP_ACTIVE_VIEW'
  | 'PRICE_GROUP_INACTIVE_VIEW'
  | 'DELETE_PRICE_GROUP'
  | 'DATE_INTERVAL_ACTIVE_VIEW'
  | 'DATE_INTERVAL_INACTIVE_VIEW'
  | 'DELETE_DATE_INTERVAL'
  | 'DELETE_SALES'
  | 'UPDATE_OR_CREATE_SALES'
  | 'UPDATE_OR_CREATE_CHEFS_STATEMENT'
