...
export const printClient = {
  ...
  getInvoice: (orderId:any) =>
    HttpClient.get<any>(`${API_ENDPOINTS.PRINTINVOICE}/${orderId}`),
  getChefStatement: (statementId:any) =>
    HttpClient.get<any>(`${API_ENDPOINTS.PRINTCHEFSTATEMENT}/${statementId}`),
};
