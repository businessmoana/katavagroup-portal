export const API_ENDPOINTS = {
  ...
  CHEFS: 'admin/chefs',
  CHEFS_GET_LOCATIONS:'admin/chefs/getLocations',
  ACTIVE_CHEF:'admin/active-chef',
  INACTIVE_CHEF:'admin/inactive-chef',
  PRICEGROUP:'admin/price-group',
  ACTIVE_PRICEGROUP:'admin/active-price-group',
  INACTIVE_PRICEGROUP:'admin/inactive-price-group',
  DATEINTERVAL:'admin/date-interval',
  ACTIVE_DATEINTERVAL:'admin/active-date-interval',
  INACTIVE_DATEINTERVAL:'admin/inactive-date-interval',
  // CHEFORDERS:'print-market-statement',
  CHEFORDERS:'admin/chefs-orders',
  ORDERITEMS:'admin/order-items',
  CHEFINVOICES:'admin/chefs-invoices',
  SALSE:'admin/sales',
  MARKET_STATEMENT:'admin/market-statement',
  PICKPACK:'admin/products/pick-pack',
