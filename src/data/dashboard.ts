...
export const useAdminAnalyticsQuery =() => {
  return useQuery([API_ENDPOINTS.ANALYTICS], dashboardAdmin.analytics);
}

export const useAdminOrdersAnalyticsQuery = () => {
  return useQuery([API_ENDPOINTS.ANALYTICS], dashboardAdmin.analyticsOrders);
}
